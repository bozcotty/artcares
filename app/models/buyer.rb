class Buyer < ActiveRecord::Base
  ...
  attr_accessible :name, :address_line_1, :address_apartment, :address_zip, :address_city, :address_country,
                  :address_country_code, :shipping_name, :shipping_address_line_1, :shipping_address_apartment, :shipping_address_zip,
